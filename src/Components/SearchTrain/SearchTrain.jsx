        ...
        <section className='container mx-auto mb-16 md:flex justify-center items-center gap-4 '>
            <aside className=''>
                <form>
                    ...
                    <div className='w-full text-center font-semibold text-white bg-green-800 hover:bg-green-700 py-2 rounded'>
                        <input className='uppercase tracking-wider' type="submit" name="" id="" value={"Search Trains"} />
                    </div>
                </form>
            </aside>
            <aside className='relative'>
                <div className='absolute right-0 text-right pt-8 pr-4'>
                    <p className='pb-4'>
                        Easy <strong className='text-green-700'>purchase</strong> of <strong className='text-green-700'>tickets</strong> using<br />
