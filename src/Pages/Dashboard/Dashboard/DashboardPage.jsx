...
const DashboardPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get('http://localhost:3001/api/v1/dashboard/total', { withCredentials: true });
    ...
    const dashboardCard = [
        {
            name: "Total Tickets",
            quantity: totalData.totalTickets,
        ...
        {
            name: "Total Stations",
            quantity: totalData.totalStation,
